...
{
    public class GetKitchenCentersValidator : AbstractValidator<GetKitchenCentersRequest>
    {
        public GetKitchenCentersValidator()
        {
            ...
            RuleFor(x => x.SortBy)
                ...
                {
                    PropertyInfo[] properties = typeof(GetKitchenCenterResponse).GetProperties();
